...
urlpatterns = [
    ...
    path("animals/protectora/metrics/", views.protectora_metrics_view, name="protectora-metrics"),
    path("animals/protectora/monthly-adoptions/", views.monthly_adoptions_view, name="protectora-monthly-adoptions"),
    path("animals/protectora/top-requested/", views.top_requested_animals_view, name="protectora-top-requested"),
    path("animals/protectora/adopted/", views.protectora_adopted_animals, name="protectora-animals-adopted"),
]
